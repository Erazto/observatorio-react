...
export const PALETTES = {
  institucional: { label: 'Institucional', reference: true, background: '#e1d8c7', heading: '#54212C', colors: ['#C4B18F', '#BC965B', '#965F36', '#9F2141', '#54212C'] },
  ...
  resiliencia_aqua: { label: 'Aqua', reference: true, background: '#95BBB8', heading: '#174C44', description: 'Cinco tonos inspirados en la referencia de resiliencia. Esta gama es una adaptación para valores ordenados; no representa las categorías del clúster.', colors: ['#DFEFE5', '#78CCB4', '#4aa093', '#249383', '#1A6D63'] },
  categoria1: { label: 'Verde', background: '#c0d7c8', heading: '#56212F', colors: ['#EDF7F0', '#CDE9D6', '#61BA7D', '#245232', '#16321F'] },
  verde_oliva: { label: 'Oliva', background: '#dce1cb', heading: '#31451D', colors: ['#F2F6E8', '#D5E2B8', '#A6BF78', '#6F8C43', '#3D5726'] },
  lilas: { label: 'Lilas', background: '#dfd8e6', heading: '#56212F', colors: ['#F5F0FA', '#DDD0ED', '#B49ACF', '#805BA6', '#48256B'] },
};
