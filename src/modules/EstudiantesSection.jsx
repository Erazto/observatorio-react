...
function EstudiantesSection({ isActive, sectionRef, matriculaChartCanvasRef }) {
  const {
    ...
    setControl,
    filters,
  } = useFilters({ ciclo: estudiantesData.meta.ciclo })
  ...
  return (
    <section
      ...
      aria-labelledby="estudiantes-heading"
      hidden={!isActive}
      tabIndex={-1}
    >
      ...
      <div style={{ marginTop: '50px' }}>
        ...
        <div className="stats-table-container">
          <table
            ...
            aria-label="Tabla detallada de estudiantes por nivel y vertiente"
          >
            <thead>
              <tr>
                <th>NIVEL</th>
              ...
              {showingGlobalTotals && (
                <>
                  <tr>
                    ...
                    <td>
                      {formatNumber(estudiantesData.modalidades.escolarizada.estatal)}
                    </td>
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.escolarizada.federalizado,
                      )}
                    </td>
                    <td>
                      {formatNumber(estudiantesData.modalidades.escolarizada.federal)}
                    </td>
                    <td>
                      {formatNumber(estudiantesData.modalidades.escolarizada.autonomo)}
                    </td>
                    <td>
                      {formatNumber(estudiantesData.modalidades.escolarizada.total)}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.no_escolarizada.estatal,
                      )}
                    </td>
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.no_escolarizada.federalizado,
                      )}
                    </td>
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.no_escolarizada.federal,
                      )}
                    </td>
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.no_escolarizada.autonomo,
                      )}
                    </td>
                    <td>
                      {formatNumber(
                        estudiantesData.modalidades.no_escolarizada.total,
                      )}
                    </td>
                  </tr>
                </>
